...
function renderOverview(){
  ...
  // keep canonical values internally when authed
  if (authed){
...
/* ===============================
   ...
   These fire when your bridge dispatches CustomEvents with types like:
   "webapp.signin", "webapp.eligibility", "webapp.options"
   =============================== */

// Sign in (event)
window.addEventListener('webapp.signin', function () {
  console.log("[app] webapp.signin received (event)");
  state.authed = true;
  state.eligibility = 'Unknown';
  renderOverview();
...
/* Optional direct hooks the bridge can call (belt & braces) */
